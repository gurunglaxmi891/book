    ...
    <section id="about-us">
         <div class="container about-parent">
            ...
            <div class="about-us-content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur incidunt dolorem tenetur impedit et error corporis veritatis animi quos excepturi?</p>
            </div>
            ...
            <div class="book-collection">
                ...
                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/book2 (1).jpg" alt="">
                    </div>
                    <div class="book-content">
                        <p class="small-font">Book About End</p>
                        <a class="small-font btn" href="">Buy Me</a>
                    </div>
                </div>

                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/book2 (4).jpg" alt="">
                    </div>
                    <div class="book-content">
...
<!-- ===================Second row for books========================= -->
        <div class="container">
            ...
            <div class="book-collection">
                ...
                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/Dark Creations (Part 1).jpg" alt="">
                    </div>
                    <div class="book-content">
                        <p class="small-font">Book About Creations</p>
                        <a class="small-font btn" href="">Buy Me</a>
                    </div>
                </div>
                ...
                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/Lone Wolf_ A Post-Apocalytpic Thriller (America Falls Book 7).png" alt="">
                    </div>
                    <div class="book-content">
                        <p class="small-font">Book About Adventure</p>
                        <a class="small-font btn" href="">Buy Me</a>
                    </div>
                 </div>
                ...
                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/Regression Poster Finds Its Victim.jpg" alt="">
                    </div>
                    <div class="book-content">
                        <p class="small-font">Book About Regression</p>
                        <a class="small-font btn" href="">Buy Me</a>
                    </div>
                 </div>
                ...
                <div class="book-item">
                    <div class="book-image">
                        <img src="./img/The Calm Beyond (2020).jpg" alt="">
                    </div>
                    <div class="book-content">
                        <p class="small-font">Book About catastrophy</p>
                        <a class="small-font btn" href="">Buy Me</a>
                    </div>
                 </div>
        ...
        <div class="container testimonial-container">
            <div class="testimonial-1 review">
                ...
                <div class="testimonial-content">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci eius, vitae possimus quod assumenda cupiditate!</p>
                </div>
            </div>
